...
if(valor_compra >= 10.00 and valor_compra <= 99.99):
    print("Desconto de 5%")
    print("Valor final: R$", valor_compra - valor_compra*(5/100))

elif(valor_compra >=100.00 and valor_compra <= 499.99):
    print("Desconto de 10%")
    print("Valor final: R$", valor_compra - valor_compra*(10/100))

elif(valor_compra >= 500.00):
    print("Desconto de 15%")
    print("Valor final: R$", valor_compra - valor_compra*(15/100))
